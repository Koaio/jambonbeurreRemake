...
ConfigACC.RateLimit = 25
ConfigACC.BanSystem = false
ConfigACC.WebhookLink = "WEBHOOK"
ConfigACC.WebhookKickMessage = "s\'est fait kick pour avoir exécuter des requêtes à la vitesse d\'un robot."
ConfigACC.WebhookBanMessage = "WEBHOOK"
ConfigACC.KickMessage = "Vous n'êtes pas autorisé d'exécuter autant de requête en peu de temps."
ConfigACC.BanMessage = "Louper"
